# scripts/segmentation/run_segmentation_inference.py
...
# ----------------------------------------------------------
# Ensure repo-root is on PYTHONPATH so `import models...` works
# This file is: <repo>/scripts/segmentation/run_segmentation_inference.py
